...
module Make (C : Connection) = struct
    ...
    (* Retrieved from https://www.postgresql.org/docs/current/static/sql-keywords-appendix.html *)
    let keywords = [| "A"; "ABORT"; "ABS"; "ABSENT"; "ABSOLUTE"; "ACCESS"; "ACCORDING"; "ACTION";
    "ADA"; "ADD"; "ADMIN"; "AFTER"; "AGGREGATE"; "ALL"; "ALLOCATE"; "ALSO"; "ALTER"; "ALWAYS"; 
    "ANALYSE"; "ANALYZE"; "AND"; "ANY"; "ARE"; "ARRAY"; "ARRAY_AGG"; "ARRAY_MAX_CARDINALITY"; "AS";
    "ASC"; "ASENSITIVE"; "ASSERTION"; "ASSIGNMENT"; "ASYMMETRIC"; "AT"; "ATOMIC"; "ATTRIBUTE";
    "ATTRIBUTES"; "AUTHORIZATION"; "AVG"; "BACKWARD"; "BASE64"; "BEFORE"; "BEGIN"; "BEGIN_FRAME";
    "BEGIN_PARTITION"; "BERNOULLI"; "BETWEEN"; "BIGINT"; "BINARY"; "BIT"; "BIT_LENGTH"; "BLOB"; 
    "BLOCKED"; "BOM"; "BOOLEAN"; "BOTH"; "BREADTH"; "BY"; "C"; "CACHE"; "CALL"; "CALLED"; "CARDINALITY";
    "CASCADE"; "CASCADED"; "CASE"; "CAST"; "CATALOG"; "CATALOG_NAME"; "CEIL"; "CEILING"; "CHAIN"; "CHAR";
    ...
    "COMMITTED"; "CONCURRENTLY"; "CONDITION"; "CONDITION_NUMBER"; "CONFIGURATION"; "CONFLICT"; "CONNECT";
    ...
    "DEFAULTS"; "DEFERRABLE"; "DEFERRED"; "DEFINED"; "DEFINER"; "DEGREE"; "DELETE"; "DELIMITER"; "DELIMITERS";
    "DENSE_RANK"; "DEPTH"; "DEREF"; "DERIVED"; "DESC"; "DESCRIBE"; "DESCRIPTOR"; "DETERMINISTIC";
    "DIAGNOSTICS"; "DICTIONARY"; "DISABLE"; "DISCARD"; "DISCONNECT"; "DISPATCH"; "DISTINCT"; "DLNEWCOPY";
    ...
    "FREEZE"; "FROM"; "FS"; "FULL"; "FUNCTION"; "FUNCTIONS"; "FUSION"; 
    ...
    "INDENT"; "INDEX"; "INDEXES"; "INDICATOR"; "INHERIT"; "INHERITS"; "INITIALLY"; "INLINE"; "INNER"; "INOUT"; "INPUT"; "INSENSITIVE"; "INSERT"; "INSTANCE"; "INSTANTIABLE"; "INSTEAD"; "INT"; "INTEGER";
    "INTEGRITY"; "INTERSECT"; "INTERSECTION"; "INTERVAL"; "INTO"; "INVOKER"; "IS"; "ISNULL"; "ISOLATION"; 
    "JOIN"; "K"; "KEY"; "KEY_MEMBER"; "KEY_TYPE"; "LABEL"; "LAG"; "LANGUAGE"; "LARGE"; "LAST"; "LAST_VALUE";
    "LATERAL"; "LEAD"; "LEADING"; "LEAKPROOF"; "LEAST"; "LEFT"; "LENGTH"; "LEVEL"; "LIBRARY"; "LIKE";
    "LIKE_REGEX"; "LIMIT"; "LINK"; "LISTEN"; "LN"; "LOAD"; "LOCAL"; "LOCALTIME"; "LOCALTIMESTAMP"; "LOCATION";
    "LOCATOR"; "LOCK"; "LOCKED"; "LOGGED"; "LOWER"; "M"; "MAP"; "MAPPING"; "MATCH"; "MATCHED"; "MATERIALIZED";
    "MAX"; "MAXVALUE"; "MAX_CARDINALITY"; "MEMBER"; "MERGE"; "MESSAGE_LENGTH"; "MESSAGE_OCTET_LENGTH"; 
    "MESSAGE_TEXT"; "METHOD"; "MIN"; "MINUTE"; "MINVALUE"; "MOD"; "MODE"; "MODIFIES"; "MODULE"; "MONTH";
    "MORE"; "MOVE"; "MULTISET"; "MUMPS"; "NAME"; "NAMES"; "NAMESPACE"; "NATIONAL"; "NATURAL"; "NCHAR"; "NCLOB";
    "NESTING"; "NEW"; "NEXT"; "NFC"; "NFD"; "NFKC"; "NFKD"; "NIL"; "NO"; "NONE"; "NORMALIZE"; "NORMALIZED";
    "NOT"; "NOTHING"; "NOTIFY"; "NOTNULL"; "NOWAIT"; "NTH_VALUE"; "NTILE"; "NULL"; "NULLABLE"; "NULLIF"; 
    "NULLS"; "NUMBER"; "NUMERIC"; "OBJECT"; "OCCURRENCES_REGEX"; "OCTETS"; "OCTET_LENGTH"; "OF"; "OFF"; 
    ...
    "OWNER"; "P"; "PAD"; "PARAMETER"; "PARAMETER_MODE"; "PARAMETER_NAME"; "PARAMETER_ORDINAL_POSITION";
    ...
    "POSITION"; "POSITION_REGEX"; "POWER"; "PRECEDES"; "PRECEDING"; "PRECISION"; "PREPARE"; "PREPARED";
    "PRESERVE"; "PRIMARY"; "PRIOR"; "PRIVILEGES"; "PROCEDURAL"; "PROCEDURE"; "PROGRAM"; "PUBLIC"; "QUOTE"; 
    "RANGE"; "RANK"; "READ"; "READS"; "REAL"; "REASSIGN"; "RECHECK"; "RECOVERY"; "RECURSIVE"; "REF"; "REFERENCES";
    ...
    "SUCCEEDS"; "SUM"; "SYMMETRIC"; "SYSID"; "SYSTEM"; "SYSTEM_TIME"; "SYSTEM_USER"; "T"; "TABLE"; "TABLES";
    "TABLESAMPLE"; "TABLESPACE"; "TABLE_NAME"; "TEMP"; "TEMPLATE"; "TEMPORARY"; "TEXT"; "THEN"; "TIES"; "TIME";
    ...
    let keyword_set =
	Array.fold_left
	    (fun s k -> String_set.add k s)
	    String_set.empty
	    keywords

    let string_is_keyword s =
	String_set.mem (String.uppercase_ascii s) keyword_set
	...
	if string_is_alphanum ident && (not (string_is_keyword ident))
	    then ident
